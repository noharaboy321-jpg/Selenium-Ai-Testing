...
def runUIServer (String targetOS, String nessusBuildBranch, String catiumBranch) {

    Common common = new Common(this)

    List testFolder = ['ui/server']
    boolean nessusHome = true
    boolean nessusPro = true
    boolean nessusManager = true
    boolean nessusExpert = true
    Integer instanceCount = 3
    String markers = "not standalone and not license_change and not browser_file_download"
